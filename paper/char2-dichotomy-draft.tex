...
induce matters over finite fields.  For example,
$n(x,y) := 1 + xy \in \F_2[x,y]$ induces the binary NAND operation on
$\F_2$, and every Boolean function is a composition of NAND;
nevertheless $x + y \notin \Clo(n)$ by Theorem~\ref{thm:F2}, since
...
keystone lemma below.  Finally, the various nondegeneracy conditions accumulated
along the way ($W \neq 0$, $\Delta \neq 0$, $A \neq 0$, $B \neq 0$)
...
engine appears to reach $xy$; we have not finished the
